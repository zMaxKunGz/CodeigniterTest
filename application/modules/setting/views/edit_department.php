<div id="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--Top header start-->
                    <h3 class="ls-top-header">แก้ไขแผนก</h3>
                    <!--Top header end -->
...
<div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">แก้ไขแผนก</h3>
                                </div>
                                <div class="panel-body">
                                <form class="form-horizontal ls_form ls_form_horizontal" action="<?php echo base_url();?>/index.php/setting/editFormDept" method="post">
                                <input type="hidden" value="<?php echo $dept['department_id']; ?>" name="id"/>
                                <div class="form-group">
                                        <label class="col-lg-2 control-label">รหัสแผนก</label>

                                        <div class="col-lg-10">
                                            <input type="text" placeholder="โปรดระบุรหัสแผนก" name="deptCode" class="form-control" value="<?php echo $dept['department_code']; ?>" > 
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="โปรดระบุแผนก" name="deptName" class="form-control" value="<?php echo $dept['department_name']; ?>" >
                                        </div>

    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--Top header start-->
                    <h3 class="ls-top-header">เพิ่มประเภทปัญหา</h3>
                    <!--Top header end -->
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">เพิ่มประเภทปัญหา</li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
                <div class="col-md-12">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">เพิ่มประเภทปัญหา</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal ls_form ls_form_horizontal" action="<?php echo base_url();?>/index.php/setting/addFormProblem" method="post">
                                <input type="hidden" name="id"/>

                                <div class="form-group">
                                    <label class="col-lg-2 control-label">ประเภทปัญหา</label>

                                    <div class="col-lg-10">
                                        <input type="text" placeholder="โปรดระบุปัญหา" name="addPromblemName" class="form-control" >
                                    </div>
                                </div>
